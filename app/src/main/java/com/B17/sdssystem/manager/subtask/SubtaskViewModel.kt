...
class SubtaskViewModel : ViewModel(), AnkoLogger{
    ...
    val subtaskResponse: MutableLiveData<SubtaskResponse> = MutableLiveData<SubtaskResponse>()
    val responseCreateSubtask: MutableLiveData<ResponseCreateSubtask> = MutableLiveData<ResponseCreateSubtask>()
    ...
    fun createSubtask(project_id : String, task_id : String, sub_task_name : String, sub_task_status : String,
                      sub_task_desc : String, start_date : String, end_date : String) {
        val apiInterface = RetrofitInstance().getRetrofitInstance().create(ApiInterface::class.java)
